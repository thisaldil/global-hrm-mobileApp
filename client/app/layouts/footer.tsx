    ...
    >
      ...
      >
        <Icon
          name="home-outline"
          size={24}
          style={{ color: activeTab === "home" ? activeColor : defaultColor }}
        />
        <Text
          style={{
            fontSize: 12,
      ...
      {/* Reminder Button */}
      <TouchableOpacity
        onPress={() => handlePress("reminder", "../reminder")}
        style={[t.itemsCenter]}
      >
        <Icon
          name="alarm-outline"
          size={26}
          style={{ color: activeTab === "reminder" ? activeColor : defaultColor }}
        />
        <Text
          style={{
            fontSize: 12,
            color: activeTab === "reminder" ? activeColor : defaultColor,
          }}
        >
          Reminder
        </Text>
      ...
      >
        <Icon
          ...
          size={24}
          style={{ color: activeTab === "message" ? activeColor : defaultColor }}
        />
        <Text
          style={{
            fontSize: 12,
            color: activeTab === "message" ? activeColor : defaultColor,
          }}
        >
          Message
        </Text>
      ...
      >
        <Icon
          name="person-outline"
          size={24}
          style={{ color: activeTab === "profile" ? activeColor : defaultColor }}
        />
        <Text
          style={{
            fontSize: 12,
            color: activeTab === "profile" ? activeColor : defaultColor,
          }}
        >
          Profile
        </Text>
